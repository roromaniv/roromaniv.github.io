...
form_master.innerHTML='<div id="shade" class="hide" style="top:0;height:100%; width:100%; position:fixed; background: rgba(0,0,0,.5); z-index: 2; display: flex;justify-content: center;"><div id="formcontainer" style="position: fixed; bottom:-500px; width: 600px; height: 500px; background: #ffffff; z-index: 3; display: none; align-items: center;"><form id="contactform" action="https://formsubmit.co/ab232390ef667673b722c371774c4ce1" method="POST"><input required type="text" name="name" placeholder="Name" /><input required type="email" name="email" placeholder="Email" /><textarea style="height: 80px;" maxlength="800" name="message" placeholder="Message"></textarea><input id="success" style="display:none; border:none; background: darkcyan;padding:1rem;width: 80%;" type="text" class="t-white bold" value="Here you go! I will be in touch shortly :)" disabled="" /><br><input type="submit" value="Send" class="black t-white" style="cursor: pointer; border: none; width: fit-content; padding: 1rem 1.5rem; height: auto;"></form></div></div>';
